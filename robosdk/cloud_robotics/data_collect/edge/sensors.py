...
class _ThreadDataCollect(threading.Thread):
    ...
    def __init__(self,
        ...
        self.robot_backend: BackendBase = (robot_backend or
...
@ClassFactory.register(ClassType.CLOUD_ROBOTICS, "data_collect_rt_client")
class CollectRTClient(WSClient):  # noqa
    ...
    def __init__(self, name: str = "dataCollect", **kwargs, ):
        ...
        _backend: BackendBase = (BaseConfig.BACKEND or ClassFactory.get_cls(
            ClassType.BACKEND, "ros1")())
...
@ClassFactory.register(ClassType.CLOUD_ROBOTICS, "data_collect_off_client")
class CollectOffClient(ClientBase):  # noqa
    ...
    def __init__(self,
        ...
        self._backend: BackendBase = (BaseConfig.BACKEND or
                                      ClassFactory.get_cls(ClassType.BACKEND,
                                                           "ros1")())
        self._worker = _ThreadDataCollect(
